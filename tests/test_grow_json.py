...
class GrowJsonTests(unittest.TestCase):
    ...
    def test_write_static_api_includes_end_node_and_children_endpoint(self):
        ...
        alias_schedule_api = grow_json.load_json(grow_json.API_DIR / "by-id" / "Q99" / "schedule.json")
        ...
        self.assertEqual(alias_schedule_api["endpoint"], "schedule")
        self.assertEqual(alias_schedule_api["id"], "Q99")
        self.assertEqual(alias_schedule_api["source"], "nodes/Q99.json")
        self.assertTrue(alias_schedule_api["exhausted"])
        self.assertFalse(alias_schedule_api["can_fetch"])
        self.assertEqual(alias_schedule_api["block_reason"], "exhausted")
        self.assertEqual(alias_index_api["id"], "Q99")
        self.assertEqual(alias_index_api["schedule"], "schedule.json")
        ...
        self.assertEqual(api_index["by_id_schedule"], "by-id/<id>/schedule.json")
        ...
        self.assertIn("getSchedule", api_client)
